...
public class Reference {
    ...
    public class Names {
        ...
        public static final String SPECORIUM_NUGGET = "nuggetSpecorium";
    ...
    public class Color {
        ...
        public static final int GREEN = 0x00FF21;
        public static final int CYAN = 0x00FFFF;
        public static final int BLUE = 0x0026FF;
        public static final int VIOLET = 0xB200FF;
        public static final int WHITE = 0xFFFFFF;
        public static final int BLACK = 0x333333;
